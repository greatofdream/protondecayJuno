...
mergeinfo = np.zeros(entries, dtype=[('eid', '<i4'), ('likelihood', '<f4'), ('E1', '<f4'), ('E2', '<f4'), ('E3', '<f4'), ('E1Norm', '<f4'), ('E2Norm', '<f4'), ('E3Norm', '<f4'), ('t1', '<f4'), ('t2', '<f4'), ('t3', '<f4'), ('npeak', '<i2'),  ('Qedep', '<f4'), ('bkg', '<f4'), ('chisquare1', '<f4'), ('chisquare2', '<f4'),('chi1','<f4'),('chi2','<f4'),('ndf','<i2'), ('Up90', 'f4'), ('t10080', '<f4'), ('over5090', '<f4'), ('nCap','<i2'), ('nMichel', '<i2'),('michelDist', '<f4'),('edepR','<f4'),('nDist','<f4')])
...
print(Ecorr)
EcorrIndex = np.floor((mergeinfo['edepR']/17700)**3*10).astype(int)
EcorrIndex[EcorrIndex>=10] = 9
mergeEcorr = np.zeros((entries,2))
mergeEcorr[mergeinfo['npeak']==1,0] = 1
mergeEcorr[mergeinfo['npeak']==1,1] = 1
# npeak=0 is no wave event
mergeEcorr[mergeinfo['npeak']==0,0] = 1
mergeEcorr[mergeinfo['npeak']==0,1] = 1

mergeEcorr[mergeinfo['npeak']==2,0] = Ecorr[EcorrIndex[mergeinfo['npeak']==2],0]
mergeEcorr[mergeinfo['npeak']==2,1] = Ecorr[EcorrIndex[mergeinfo['npeak']==2],1]

mergeEcorr[mergeinfo['npeak']==3,0] = Ecorr[EcorrIndex[mergeinfo['npeak']==3],2]
mergeEcorr[mergeinfo['npeak']==3,1] = Ecorr[EcorrIndex[mergeinfo['npeak']==3],3]

mergeinfo['eid'] = fitRes['eid']
mergeinfo['likelihood'] = fitRes['likelihood']
mergeinfo['E1'] = fitRes['E1']/mergeEcorr[:,0]
mergeinfo['E2'] = fitRes['E2']/mergeEcorr[:,1]
